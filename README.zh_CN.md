...
- **客户端**：在 release 目录下运行与您的操作系统匹配的脚本：
    - Windows：运行 `install-client.bat`
    - macOS：运行 `install-client.command`
    - Linux：运行 `./install-client.sh`
...
- **客户端**：在 release 目录下运行与您的操作系统匹配的脚本：
    - Windows：运行 `uninstall-client.bat`
    - macOS：运行 `uninstall-client.command`
    - Linux：运行 `./uninstall-client.sh`
